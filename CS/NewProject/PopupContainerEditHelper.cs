...
namespace NewProject
{
    public class PopupContainerEditHelper
    {
        ...
        {
            foreach (int number in CheckedListBox.CheckedIndices)
        ...
        protected virtual CheckedListBoxControl CreateCheckedListBoxControl()
        {
        ...
        public CheckedListBoxControl CheckedListBox { get; private set; }
